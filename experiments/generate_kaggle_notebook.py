...
notebook = {
    "cells": [
        ...
        },
        {
            ...
            "source": [
                "%%bash\n",
                "# Step 3: Setup BETA codebase and assets (bundle or git clone)\n",
                "if [ ! -d \"beta\" ]; then\n",
                ...
                "  fi\n",
                "fi\n",
                "python -c \"import os; assert os.path.exists('beta') and os.path.exists('assets/similarity_encoder.pt'); print('BETA codebase and assets verified!')\"\n"
            ]
        },
        {
            "cell_type": "code",
